...
public class newAccountBankUI {
	...
	public static final String CURRENT_AMOUNT= "//td[text()='Current Amount']";
	public static final String VALUE_CURRENT_AMOUNT= "//td[text()='Current Amount']/following-sibling::td";
